...
const DETAILS = [
  { Icon: Mail, label: "Email", value: "huyth.dev@gmail.com", href: "mailto:huyth.dev@gmail.com" },
  { Icon: Phone, label: "Phone", value: "+84 334 114 244", href: "tel:+84334114244" },
  { Icon: MapPin, label: "Location", value: "Ninh Kiều, Cần Thơ, Vietnam" },
]
      ...
      <section className="container-page pt-32 pb-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            Have a role, a project, or just want to say hi? Send a message and I'll get back to you soon.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-8">
            ...
            <div>
              <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Elsewhere</p>
